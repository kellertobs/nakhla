...
text( 0.99,-0.04,LBL1,'FontSize',18,'Interpreter','latex','HorizontalAlignment','left','VerticalAlignment','middle');
text(0.47,0.87,LBL2,'FontSize',18,'Interpreter','latex','HorizontalAlignment','left','VerticalAlignment','bottom');
text(0.03,-0.04,LBL3,'FontSize',18,'Interpreter','latex','HorizontalAlignment','right','VerticalAlignment','middle');
