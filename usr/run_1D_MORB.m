...
Twall    =  [nan,nan,nan];       % [top,bot,sds] wall rock temperature [degC] (nan = insulating)
cwall    =  nan(3,7);
...
Delta_cnv=  0*h/2;                 % correlation length for eddy, convection diffusivity (multiple of h, 0.5-1)
Delta_sgr=  0*dx0*10;              % correlation length for phase fluctuation diffusivity (multiple of dx0, df0, 10-20)
