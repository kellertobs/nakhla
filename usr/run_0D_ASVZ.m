...
tend     =  1e1*hr;              % end time for simulation [s]
...
c0       =  [0.13  0.22  0.32  0.19  0.09  0.05  0.02];  % components (maj comp, H2O) top  layer [wt] (will be normalised to unit sum!)
...
eta_wall =  1e0;                % wall rock viscosity [Pas]
mod_wall =  0e0;                % wall rock elastic modulus [Pa]
