...
L        =  5;                   % chamber width [m]
N        =  240;                 % number of grid points in z-direction (incl. 2 ghosts)
...
Twall    =  [300,300,300];       % [top,bot,sds] wall rock temperature [degC] (nan = insulating)
