...
% set run parameters
runID     =  '2D_rchrg_bot';          % run identifier
...
c0        =  [0.001 0.001 0.001 0.021 0.324 0.652 0.024];  % components (maj comp, H2O) top  layer [wt] (will be normalised to unit sum!)
c1        =  [0.049 0.136 0.520 0.168 0.100 0.027 0.003];  % components (maj comp, H2O) base layer [wt] (will be normalised to unit sum!)
