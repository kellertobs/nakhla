...
% set run parameters
runID    =  '1D_fract_anh_mars'; % run identifier
...
cphs1    =  0.81;                % phase diagram upper bound composition [wt SiO2]
Tphs0    =  825;                 % phase diagram lower bound temperature [degC]
Tphs1    =  1724;                % phase diagram upper bound temperature [degC]
PhDg     =  [5.7,3.5,1.0,1.6];   % Phase diagram curvature factor (> 1)
perCm    =  0.515;               % peritectic liquidus composition [wt SiO2]
perCx    =  0.475;               % peritectic solidus  composition [wt SiO2]
perT     =  1106;                % peritectic temperature [degC]
...
rhox0    =  3150;                % crystal phase ref. density [kg/m3] (at T0,cphs0,Ptop)
...
gCm      =  0.6;                 % melt compositional expansion [1/wt]
gCx      =  0.8;                 % xtal compositional expansion [1/wt]
