...
wlay     =  0.01;                % thickness of smooth layer boundary (relative to domain depth D)
T0       =  500;                 % temperature top layer [deg C]
...
si0      = -10;                  % stable isotope ratio top layer [delta]
