...
N        =  400;                 % number of grid points in z-direction (incl. 2 ghosts)
...
T0       =  1680;                % temperature top  layer [deg C]
T1       =  1680;                % temperature base layer [deg C]
c0       =  [0.38  0.17  0.16  0.22  0.07  0];  % components (maj comp, H2O) top layer [wt] (will be normalised to unit sum!)
c1       =  [0.38  0.17  0.16  0.22  0.07  0];  % components (maj comp, H2O) bot layer [wt] (will be normalised to unit sum!)
dcr      =  [2,1,-1,-1,-1,0]*0e-4;  % amplitude of random noise [wt]
...
Delta_cnv=  10*h;                % correlation length for eddy, convection diffusivity (multiple of h, 0.5-1)
