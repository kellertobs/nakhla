...
tend     =  5*yr;                % end time for simulation [s]
dt       =  hr/2;                % initial time step [s]
dtmax    =  10*hr;               % maximum time step [s]
...
T0       =  820;                 % temperature top layer [deg C]
T1       =  820;                 % temperature base layer [deg C]
...
tau_T    =  1e3*hr;              % wall cooling/assimilation time [s]
tau_a    =  1e3*hr;              % wall cooling/assimilation time [s]
...
bPf      =  2e-8;                % mvp compressibility [1/Pa]
...
etamin   =  1e5;                 % minimum viscosity for stabilisation
etamax   =  1e11;                % maximum viscosity for stabilisation
