...
tau_a    =  16*hr;               % wall cooling/assimilation tie [s]
Twall    =  300;                 % wall temperature [degC] (nan = insulating)
cwall    =  0.7;                 % wall major component [wt SiO2] (nan = no assimilation)
vwall    =  0.04;                % wall volatile component [wt H2O] (nan = no assimilation)
tewall   =  [0.1,0.3,1.5,3];     % wall trace elements [wt ppm] (nan = no assimilation)
irwall   =  [-2,0.72];           % wall isotope ratios [delta] (nan = no assimilation)
