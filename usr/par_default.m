...
cPm       =  1250;                % melt  heat capacity [J/kg/K]
...
etamin    =  1e-16;               % minimum viscosity hard limit
etamax    =  1e+16;               % maximum viscosity hard limit
etalim    =  'centr';             % adaptive viscosity limiter mode ('centr','lower','upper')
etacntr   =  1e+6;                % maximum viscosity contrast for adaptive mode
