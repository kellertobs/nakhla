...
% set run parameters
runID     =  '2D_TORF_rchrg_layers'; % run identifier
...
T1        =  700;                 % temperature base layer [deg C]
c0        =  [0.03 0.42 0.41 0.13 0.01 0.005];  % components (maj comp, H2O) top  layer [wt] (will be normalised to unit sum!)
c1        =  [0.01 0.03 0.07 0.33 0.56 0.030];  % components (maj comp, H2O) base layer [wt] (will be normalised to unit sum!)
dcr       =  [1,1,1,-1,-1,-1,0]*1e-6;
trc0      =  [1,1,1,1,1,1];        % trace elements top layer [wt ppm]
trc1      =  [0.1,0.3,0.5,3,10,2]; % trace elements base layer [wt ppm]
